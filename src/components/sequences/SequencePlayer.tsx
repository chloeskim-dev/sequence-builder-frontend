...
import CheckboxOptionsContainer from "../ui/CheckboxOptionsContainer";
...
export default function GuidedSequencePlayer({
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className={sectionTitleStyles}>{sequence.name}</div>
            <div className="flex w-[80%] md:w-[60%] bg-red-100 p-8 rounded-xl">
                        ...
                        <div>
                            <div className="flex flex-wrap gap-2 my-4">
                                {isRunning ? (
                                    <button
                                        onClick={handlePause}
                                        className="font-bold text-sm px-4 py-2 bg-blue-600 text-white"
                                    >
                                        Pause
                                    </button>
                                ) : (
                            ...
                            {nextExercise && showNextExercisePreview && (
                                <div className="my-2 p-3 bg-gray-50 border-l-4 border-blue-300">
                                    ...
                                    <div className={`${flexGridStyles} pl-2`}>
                                        <div
                                            className={nextExerciseLabelStyles}
                                        >
                                            Direction
                                        </div>
                                        <div className={nextExerciseTextStyles}>
                                            {typeof nextExercise.direction ===
                                                "string" &&
                                        ...
                                        <div className={nextExerciseTextStyles}>
                                            {typeof nextExercise.resistance ===
                                                "string" &&
                                        ...
                                        <div className={nextExerciseTextStyles}>
                                            {typeof nextExercise.duration_secs ===
                                                "number" &&
                                                formatTime(
                                                    nextExercise.duration_secs
                                                )}
                                        </div>
                                    </div>
                                </div>
